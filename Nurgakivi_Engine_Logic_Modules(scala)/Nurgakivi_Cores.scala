...
// Custom SoC Goal Clock Frequency Between 1.6 GHz - 2.3 GHz
...
// Rocket 4 Big Cores & Large Boom 4 Cores -> 8 Cores 
...
// MIAOW GPU ALU Verilog Code By Blackbox
// Needs Customizing Core fixes 
